...
<div class="container-fluid text-center">
  <div class="row align-items-center bg-secondary" style="footer">
    <div class="col-sm-2">
      <img src="<?php echo get_template_directory_uri() . '/assets/images/ClimateHubLogo.gif'; ?>" class="img-fluid border-0 footer-logo"/>
    </div>
    <div class="col-sm-2">
    ...
    <div class="col-sm-2 align-middle mt-2 mb-2">
