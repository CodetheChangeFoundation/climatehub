...
function climatehub_load_scritps() {
...
add_action('wp_enqueue_scripts', 'climatehub_load_scritps');

function climatehub_load_bootstrap_scritps() {
...
add_action('wp_enqueue_scripts', 'climatehub_load_bootstrap_scritps');